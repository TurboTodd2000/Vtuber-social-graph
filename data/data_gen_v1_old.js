...
const interestNode = [
	...
	[ 6, "interests", "INTERESTS", "Sexuality", [1012, 9039, 9036, 9040, 9035], true ],
...
const formalGroupNodes = [
	...
	// dentsu.exe
	[ 102,  "group", "DENTSU", "dentsu.exe",  typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [2001, 2002, 2003], "blue", ],

	// nova
	[ 103, "group", "NOVA", "Nova", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [3001, 3002, 3003, 3004], "red" ],

	// beastiez
	[ 104, "group", "BEASTIEZ", "Beastiez", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [4001, 4002, 4003, 4004], "purple" ],

	// vichi ban
	[ 105, "group", "VICHIBAN", "VchiBan", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [7001, 7002, 7003, 7004], "yellow" ],

	// hololive
	[ 110, "group", "HOLOLIVE", "Hololive", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [111, 113, 114], "green" ],


	[ 111, "group", "HOLOLIVE", "Hololive EN", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [112, 116, 117, 120], "green" ],

	[ 112, "group", "HOLOLIVE", "Myth", typeGroupNodeShape, typeSubgroupSize, typeGroupNodeLabelSize, [11001, 11014, 11015], "green" ],

	[ 116, "group", "HOLOLIVE", "Justice", typeGroupNodeShape, typeSubgroupSize, typeGroupNodeLabelSize, [11003, 11020, 11021, 11022], "green" ],

	[ 117, "group", "HOLOLIVE", "Advent", typeGroupNodeShape, typeSubgroupSize, typeGroupNodeLabelSize, [11002, 11016, 11017, 11018, 11019], "green" ],

	[ 120, "group", "HOLOLIVE", "Holostars EN", typeGroupNodeShape, typeSubgroupSize, typeGroupNodeLabelSize, [11013], "green" ],


	[ 113, "group", "HOLOLIVE", "Hololive Indo", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [11004, 11005, 11006, 11007, 11008, 11009], "green" ],

	[ 114, "group", "HOLOLIVE", "Hololive JP", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [11023, ], "green" ],

	// first stage
	[ 115, "group", "FIRST_STAGE", "First Stage", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [12001], "green" ],

	// teri-yaki
	[ 118, "group", "TERI-YAKI", "TERI-yaki", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [13001], "yellow" ],
	
	// nijisanji
	[ 119, "group", "NIJISANJI", "Nijisanji", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [] ],

	//lab brats
	[  202,  "group", "LAB_BRATS", "Lab Brats", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [5001, 5002, 5003, 5005], "LightSeaGreen" ],

	// neuroverse
	[ 208, "group", "NEUROVERSE", "Neuroverse", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [8001, 8002, 8003], "YellowGreen" ],
...
const informalGroupNodes = [
	...
	//vshojo
	[ 205,  "group", "VSHOJO", "ex-Vshjo", typeGroupNodeShape,  typeGroupNodeSize,  typeGroupNodeLabelSize, [1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 102, 103, 104 ], "black" ],

	// fleshtubers
	[ 206, "group", "FLESHTUBERS", "Fleshtubers", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010 ], "firebrick" ],

	// indies
	[ 207, "group", "INDIES", "Indies", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [5001, 5002, 5003, 5005, 6001, 6002, 6003, 6004, 7001, 7002, 7003, 7004, 8001, 8002, 8003, 9001, 9002, 9003, 9004, 9005, 9006, 9007, 9008, 9009, 9010, 9011, 9012, 9013, 9014, 9015, 9016, 9017, 9018, 9019, 9020, 9021, 9022, 9023, 9024, 9025, 9026, 9027, 9028, 9029, 9030, 9031, 9032, 9033, 9034, 9035, 9036, 9037, 9038, 9039, 9040, 9041, 9042, 1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 2001, 2002, 2003, 4001, 4002, 4003, 4004, 6005, 9043, 3001, 3002, 3003, 3004, 9044, 6006, 9045, 9046, 9047, 9048, 9049, 9050, 9051, 9052, 9053 ], "orange" ],

	// indo girlypops
	[ 209, "group", "INDO_GIRLYPOPS", "Indo Girlypops", typeGroupNodeShape, typeGroupNodeSize, typeGroupNodeLabelSize, [11004, 11005, 11006, 11007, 11008, 11009, 13001, 1002, ], "DarkOrchid" ],
...
//kumi
	...
	[ 10010, "talent", "FLESHTUBERS", "Ado", "https://www.youtube.com/@ado1024", "", "https://en.wikipedia.org/wiki/Ado_(singer)", [], ],
	//RubinSargasm
	...
	[ 11023, "talent", "HOLOLIVE", "Hoshimachi Suisei", "https://www.youtube.com/channel/UC5CwaMl1eIgY8h02uZw7u8A", "", "https://en.wikipedia.org/wiki/Hoshimachi_Suisei#External_links", [], ],
...
const fontColorNodeText = `, color: "black", strokeWidth: 6, strokeColor: "#ffffff", }`;
const fontColorText = `", font: { color: "`;
...
//node colors
const nodeColorText = `, color: {background: "`;
	...
	if (currentInterestNode[4].length > 0) {
	   ...
	   //edge elements
		for (var ee = 0; ee < currentInterestNode[4].length; ee++) {
			...
			var edgeHTMLoutput = fromText + currentInterestNode[0] + toText + currentInterestNode[4][ee] + typeText + currentInterestNode[1] + talentEndText;
...
for (var a = 0; a < formalGroupNodes.length; a++) {
	...
	var nodeHTMLoutput = idText + currentFormalGroupNodes[0] + typeText + currentFormalGroupNodes[1] + groupText + currentFormalGroupNodes[2] + labelText + currentFormalGroupNodes[3] + shapeText + currentFormalGroupNodes[4] + sizeNodeText + currentFormalGroupNodes[5] + fontSizeText + currentFormalGroupNodes[6] + fontColorText + nodeColorText + currentFormalGroupNodes[8] + nodeEndText;
   ...
   //edge elements
		for (var ee = 0; ee < currentFormalGroupNodes[7].length; ee++) {
			...
			var edgeHTMLoutput = fromText + currentFormalGroupNodes[0] + toText + currentFormalGroupNodes[7][ee] + typeText + currentFormalGroupNodes[1] + talentEndText;
...
for (var a = 0; a < informalGroupNodes.length; a++) {
	...
	var nodeHTMLoutput = idText + currentInformalGroupNodes[0] + typeText + currentInformalGroupNodes[1] + groupText + currentInformalGroupNodes[2] + labelText + currentInformalGroupNodes[3] + shapeText + currentInformalGroupNodes[4] + sizeNodeText + currentInformalGroupNodes[5] + fontSizeText + currentInformalGroupNodes[6] + fontColorText + nodeColorText + currentInformalGroupNodes[8] + nodeEndText;
...
for (var a = 0; a < talentNodes.length; a++) {
	...
	var nodeHTMLoutput = idText + currentTalentNode[0] + typeText + currentTalentNode[1] + groupText + currentTalentNode[2] + labelText + currentTalentNode[3] + youtubeText + currentTalentNode[4] + twitchText + currentTalentNode[5] + wikiText + currentTalentNode[6] + fontColorText + currentTalentNode[8] + talentEndText;
